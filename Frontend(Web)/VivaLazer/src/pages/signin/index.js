...
export default class SignIn extends Component {
  ...
  //Função de SUBMIT
  handleSubmit(event) {
    if (this.state.cnpj.length === 0 || this.state.senha.length === 0) {
      ...
      API.get('/' + this.state.cnpj + '/' + this.state.senha).then((result) => {
        ...
        <Row>
          <Col>
            <Card className="shadow p-5 mb-5 bg-white rounded formLogin box">
              ...
              <Form onSubmit={this.handleSubmit} className="mt-2 p-3">
