  ...
  render() {
    return (
      <Container>
        <Row>
          <Col>
            <Card className="shadow p-5 mb-3 bg-white rounded formLogin box">
              <Form onSubmit={this.handleSubmit} className="p-3">
                <Form.Group controlId="" className="">
                  <Form.Label>Nome</Form.Label>
                  <Form.Control type="text" name="nome" placeholder="Nome fantasia" value={this.state.nome} onChange={this.handleChange} />
                </Form.Group>
                <Form.Group controlId="" className="">
                ...
                <Form.Group controlId="">
                  ...
                  <Form.Control type="text" name="cnpj" placeholder="CNPJ" value={this.state.cnpj} onChange={this.handleChange} />
                </Form.Group>
                <Form.Group controlId="">
